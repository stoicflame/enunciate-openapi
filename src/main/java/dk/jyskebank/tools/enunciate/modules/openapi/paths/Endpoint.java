...
public class Endpoint {
  ...
  public Endpoint(EnunciateLogger logger, OperationIds operationIds, List<Resource> resources, ResourceApi resourceApi, ResourceGroup resourceGroup, PathSummary pathSummary) {
    this.resourceGroup = resourceGroup;
    this.pathSummary = pathSummary;
    
    for (Resource resource : resources) {
      for (Method m : resource.getMethods()) {
        operations.add(new Operation(logger, operationIds, m, resourceGroup));
      }
    }    
  }
