...
public class SecurityScheme {
	...
	private SecuritySchemeRenderer renderer;

	public SecurityScheme(EnunciateLogger logger, ObjectTypeRenderer objectTypeRenderer, String schemeId, String name,
		...
		this.flows = flows;
		this.renderer = new SecuritySchemeRenderer(logger, objectTypeRenderer, this);
	}
	...
	public SecuritySchemeRenderer getRender() {
		return renderer;
	}
